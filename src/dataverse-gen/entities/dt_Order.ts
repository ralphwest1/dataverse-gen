...
export const dt_orderCollections = {
  dt_order_rc_conversations: ["mscrm.rc_conversation"],
  dt_order_powf_webformactivities: ["mscrm.powf_webformactivity"],
  dt_order_po_creditcardtransactions: ["mscrm.po_creditcardtransaction"],
  dt_order_po_achtransactions: ["mscrm.po_achtransaction"],
  dt_order_msfp_surveyresponses: ["mscrm.msfp_surveyresponse"],
  dt_order_msfp_surveyinvites: ["mscrm.msfp_surveyinvite"],
  dt_order_msfp_alerts: ["mscrm.msfp_alert"],
  dt_order_msdyn_ocsessions: ["mscrm.msdyn_ocsession"],
  dt_order_msdyn_ocliveworkitems: ["mscrm.msdyn_ocliveworkitem"],
  dt_order_msdyn_bookingalerts: ["mscrm.msdyn_bookingalert"],
  dt_order_li_pointdrivepresentationvieweds: ["mscrm.li_pointdrivepresentationviewed"],
  dt_order_li_messages: ["mscrm.li_message"],
  dt_order_li_inmails: ["mscrm.li_inmail"],
  dt_order_dt_WebFormActivities: ["mscrm.dt_webformactivity"],
  dt_order_dt_Updates: ["mscrm.dt_update"],
  dt_order_dt_Notes: ["mscrm.dt_note"],
  dt_order_dt_GenericSampleses: ["mscrm.dt_genericsamples"],
  dt_order_connections2: ["mscrm.connection"],
  dt_order_connections1: ["mscrm.connection"],
  dt_order_chats: ["mscrm.chat"],
  dt_order_Tasks: ["mscrm.task"],
  dt_order_SyncErrors: ["mscrm.syncerror"],
  dt_order_SocialActivities: ["mscrm.socialactivity"],
  dt_order_SharePointDocumentLocations: ["mscrm.sharepointdocumentlocation"],
  dt_order_ServiceAppointments: ["mscrm.serviceappointment"],
  dt_order_RecurringAppointmentMasters: ["mscrm.recurringappointmentmaster"],
  dt_order_ProcessSession: ["mscrm.processsession"],
  dt_order_PrincipalObjectAttributeAccesses: ["mscrm.principalobjectattributeaccess"],
  dt_order_PhoneCalls: ["mscrm.phonecall"],
  dt_order_MailboxTrackingFolders: ["mscrm.mailboxtrackingfolder"],
  dt_order_Letters: ["mscrm.letter"],
  dt_order_Faxes: ["mscrm.fax"],
  dt_order_Emails: ["mscrm.email"],
  dt_order_DuplicateMatchingRecord: ["mscrm.duplicaterecord"],
  dt_order_DuplicateBaseRecord: ["mscrm.duplicaterecord"],
  dt_order_BulkDeleteFailures: ["mscrm.bulkdeletefailure"],
  dt_order_AsyncOperations: ["mscrm.asyncoperation"],
  dt_order_Appointments: ["mscrm.appointment"],
  dt_order_Annotations: ["mscrm.annotation"],
  dt_order_ActivityPointers: ["mscrm.activitypointer"],
  dt_ReorderReminder_OrderId_dt_Order: ["mscrm.dt_reorderreminder"],
  dt_Order_dt_DesignProof: ["mscrm.dt_designproof"],
  dt_Order_Shipment: ["mscrm.dt_shipment"],
  dt_Order_OrderTaskEstimate: ["mscrm.dt_ordertaskestimate"],
  dt_Order_OrderTask: ["mscrm.dt_ordertask"],
  dt_Order_OrderEstimateLine: ["mscrm.dt_orderestimateline"],
  dt_Order_CostItemDetail: ["mscrm.dt_costitemdetail"],
  dt_OrderStage_Order_dt_Order: ["mscrm.dt_orderstage"],
  dt_OrderProcessStage_Order_dt_Order: ["mscrm.dt_orderprocessstage"],
  dt_OrderLine_Order_dt_Order: ["mscrm.dt_orderline"],
  dt_OrderDefects_Order_dt_Order: ["mscrm.dt_orderdefects"],
  dt_Opportunity_ReorderFromOrder_dt_Order: ["mscrm.opportunity"],
